        ...
        <div class="col-lg-9">
            <div class="card shadow-sm">
                <div class="card-header bg-white">
                    ...
                    <h1 class="h4 mb-0 mt-2">Editar pergunta</h1>
                </div>
                <div class="card-body">
                    <form method="POST" action="{{ route('professor.perguntas.update', $pergunta) }}">
                        @csrf @method('PUT')
                        @include('partials.erros')
                        <div class="mb-3">
                            <label for="texto" class="form-label fw-semibold">Enunciado</label>
                            <textarea id="texto" name="texto" rows="2" class="form-control @error('texto') is-invalid @enderror" required>{{ old('texto', $pergunta->texto) }}</textarea>
                        ...
                        @include('professor.perguntas._alternativas', ['pergunta' => $pergunta])
