                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('professor.salas.perguntas.store', $sala) }}">
                        ...
                        <div class="mb-4">
                            ...
                            <input id="tempo_segundos" type="number" min="3" max="300" name="tempo_segundos" value="{{ old('tempo_segundos', 20) }}" class="form-control @error('tempo_segundos') is-invalid @enderror" required>
